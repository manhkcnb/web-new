  ...
  <div class="tabs-container">
    <div class="row" style="margin-top:10px;">
      <div class="head-tabs head-tab1 col-lg-12">
        <h2>Tìm kiếm giá từ: {{ number_format($fromPrice) }} đến {{number_format($toPrice)}}</h2>
      </div>
      ...
      <div class="clearfix">
        ...
        <div class="col-xs-6 col-md-3 col-sm-6 ">
          <div class="product-grid" id="product-1168979" style="height: 370px; overflow: hidden;border-radius:3% 3%">
            <div class="image"> <a href="#"><img style="height:142px" src="{{ asset('upload/products/'.$row->photo) }}"
                  title="{{ $row->name }}" alt="{{ $row->name }}" class="img-responsive"></a> </div>
            <div class="info">
